...
int main()
{
	...
	std::cout << "x < 6           : "; std::copy_if(b, e, out, x < 6);
	std::cout << '\n';

	std::cout << "x > 15          : "; std::copy_if(b, e, out, x > 15);
	std::cout << '\n';

	std::cout << "x > 5 && x < 13 : "; std::copy_if(b, e, out, (x > 5) && (x < 
		13));
	std::cout << '\n';

	std::cout << "2 * x == x + 5  : "; std::copy_if(b, e, out, 2 * x == x + 5);
	std::cout << '\n';

	std::cout << "3 * x != x * x  : "; std::copy_if(b, e, out, 3 * x != x * x);
	std::cout << '\n';

	std::cout << "!(x < 18)       : "; std::copy_if(b, e, out, !(x < 18));
	std::cout << '\n';
}
